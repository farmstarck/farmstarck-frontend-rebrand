          ...
          <div className="w-full mt-10 flex items-center justify-center flex-col gap-5">
            ...
            <div className="flex w-full items-start flex-col gap-3">
              <button
                ...
                className="w-full px-6 py-2 rounded-full hover:bg-red-600 text-white  border bg-red-500 "
              >
                Yes, continue
              </button>
              <button
                onClick={onClose}
                className="w-full px-6 py-2 hover:bg-primary hover:text-white transition-colors rounded-full border text-primary border-primary"
              >
                No, go back
              </button>
            </div>
        ...
        {cancel && !refundProcessed && (
          <div className="w-full mt-10 flex items-center justify-center flex-col gap-5">
            ...
            <button
              ...
              className="w-full px-6 py-2 text-white transition-colors rounded-full bg-primary "
            >
              Request Refund
            </button>
