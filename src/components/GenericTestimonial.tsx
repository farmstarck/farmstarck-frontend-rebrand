...
const Testimonial = () => {
  ...
  return (
    <div className="w-full cabinet flex flex-col items-center gap-3 md:gap-5">
      <div className="flex flex-col items-center gap-3 md:gap-5">
        <h2 className="text-xl sm:text-3xl md:text-4xl  text-center leading-tight font-extrabold dark-green-txt text-centers">
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col gap-4 md:gap-10 items-center md:items-start">
                    ...
                    <div className="flex items-center justify-center gap-1">
                      <button
                        onClick={prev}
                        className="p-2 primary-txt transition"
                      >
                        <ArrowLeft size={24} />
                      </button>
