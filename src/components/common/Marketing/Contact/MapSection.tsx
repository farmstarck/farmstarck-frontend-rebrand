    ...
    <div className=" w-full ">
      <div className="relative w-full max-w-3xl mx-auto">
        <div className="flex flex-col gap-5 items-center md:items-start">
          <h5 className="text-sm font-semibold font-subHeading2 uppercase">our offices</h5>
          <h2 className="uppercase font-medium w-full text-center md:text-start  sm:text-2xl md:text-3xl">
            298, herbert macaulay way, sabo yaba, lagos state, nigeria.
          </h2>
          <h2 className="uppercase font-medium w-full text-center mt-3 md:text-start  sm:text-2xl md:text-3xl">
            +234 813 039 5444
          </h2>
          <h2 className="w-full font-medium text-center md:text-start  sm:text-2xl md:text-3xl">
