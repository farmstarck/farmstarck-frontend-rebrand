    ...
    <div className="px-5 py-6 md:py-20">
      <div className="max-w-6xl m-auto flex flex-col space-y-10 justify-between items-center md:items-start">
        <div className="max-w-lg m-auto ">
          <Image width={500} height={300} src={'/assets/images/section-img1.png'} alt="" loading="lazy" />
        </div>
          ...
          <div className="grid grid-cols-1 w-full  md:gap-y-10  gap-x-10 md:gap-x-16 md:grid-cols-4 justify-center items-stretch sm:grid-cols-2">
            {workData?.map((data, index) => (
              <div
                ...
                key={index}
              >
                <div className="shadow-xl h-14 w-14 flex justify-center items-center rounded-full bg-dark-primary">
                ...
                <div className="flex flex-col gap-4">
                  <p className="text-center font-semibold text-xs capitalize md:text-start">
                    {data.header}
                  </p>
