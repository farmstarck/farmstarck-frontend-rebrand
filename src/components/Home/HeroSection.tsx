...
const HeroSection = () => {
  return (
    <div className="lite-bg">
      <div className="max-w-6xl m-auto p-5 relative cabinet flex flex-col justify-center items-center ">
        {/* Top Section */}
        <div className="relative rounded-xl bg-white flex flex-col justify-center items-center gap-2 w-full pt-8  px-4 pb-32 md:pb-56 lg:pb-80">
          <h3 className="cabinet dark-primary-txt font-bold text-lg text-center">
            Reimagining Agriculture for the New Economy
          </h3>
          <h1 className="font-bold text-3xl  sm:text-4xl md:text-5xl lg:text-6xl primary-txt text-center">
            One Platform to
          </h1>
          <h1 className="font-bold dark-green-txt  text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center">
            Source, Save & Scale
          </h1>
          <div className="rounded-md bg-[#FFBB28] p-2 sm:p-3 md:p-4">
            <p className="uppercase font-bold  dark-primary-txt text-center text-xs  sm:text-sm md:text-base">
        ...
        <div className="w-full max-w-3xl -mt-24 md:-mt-44 lg:-mt-64 overflow-hidden rounded-2xl flex flex-col items-center z-10 gap-5">
          <Image
            width={800}
            height={800}
            src={'/assets/images/hero-testt.png'}
            alt="Hero"
