...
const Services = {
  ...
  getRelatedProducts: async (productId: string, filters: any) => {
    const params = buildProductFilterQuery(filters);
  ...
  getBestSellingProducts: async (filters: any) => {
    const params = buildProductFilterQuery(filters);
  ...
  getMostViewedProducts: async (filters: any) => {
    const params = buildProductFilterQuery(filters);
  ...
  getPopularProducts: async (filters: any) => {
    const params = buildProductFilterQuery(filters);
