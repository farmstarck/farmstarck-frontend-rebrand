...
export const nigerianStatesWithLGAs:statesTypes[] = [
    ...
    },
    {
        ...
        lgas: [
            ...
            "Udu", "Ughelli North", "Ughelli South", "Ukwuani", "Uvwie", "Warri North", "Warri South", "Warri South West"
        ]
    },
    {
        state: "Ebonyi",
    ...
    },
    {
        ...
        lgas: [
            ...
            "Kiri Kasama", "Kiyawa", "Kaugama", "Maigatari", "Malam Madori", "Miga", "Ringim", "Roni", "Sule Tankarkar", "Taura", "Yankwashi"
        ]
    },
    {
        state: "Kaduna",
    ...
    },
    {
        ...
        lgas: [
            ...
            "Ikenne", "Imeko Afon", "Ipokia", "Obafemi Owode", "Odeda", "Odogbolu", "Ogun Waterside", "Remo North", "Shagamu", "Yewa North", "Yewa South"
        ]
    },
    {
        state: "Ondo",
    ...
    },
    {
        ...
        lgas: [
            ...
            "Gummi", "Gusau", "Kaura Namoda", "Maradun", "Maru", "Shinkafi", "Talata Mafara", "Tsafe", "Zurmi"
        ]
    }
];
...
// Get all states
export const allStates = nigerianStatesWithLGAs.map(state => state.state);
...
// // Count total LGAs
// export const totalLGAs = nigerianStatesWithLGAs.reduce((total, state) => total + state.lgas.length, 0);
// // This should give you 774 (the official number of LGAs in Nigeria)