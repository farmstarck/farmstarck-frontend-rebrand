...
import { useWishlistStore } from '@/store/Client/CartSlice';
...
const WishListItems = () => {
        ...
        return (
            <div className="w-full py-5" style={{ backgroundColor: '#E8F5E9' }}>
                <div className="w-11/12 lg:max-w-7xl mx-auto">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-6 mt-6">My Wishlist</h1>

                    <div className="flex w-full flex-col items-center  bg-white max-w-4xl rounded-md mx-auto justify-center mb-20 py-20">
                        <div className="bg-white rounded-full ">
                            <Image src={'/assets/images/wishimg.png'} alt='cart image'
                                height={200} width={200}
                            />
                        </div>
                        <h2 className="text-2xl font-bold text-gray-900 mb-1">Your wishlist is empty</h2>
                        <p className="text-gray-600 mb-3">Your have not added any item to your wishlist</p>
    ...
    return (
        <>
            <div className="w-full py-5" style={{ backgroundColor: '#E8F5E9', minHeight: '100vh' }}>
                <div className="w-11/12 lg:max-w-7xl mx-auto">
                    <Navigation
                        routes={[
                            { name: 'Wishlist', href: '' },
                                ...
                                >
                                    ...
                                    <div className="md:hidden space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            ...
                                            <div>
                                                <span className="text-gray-500 text-xs">Date Added:</span>
