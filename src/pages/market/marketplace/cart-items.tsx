        ...
        return (
            <div className="w-full py-5 bg-lite">
                <div className="w-11/12 lg:max-w-7xl mx-auto">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-6 mt-6">My Cart</h1>

                    <div className="flex w-full flex-col items-center  bg-white max-w-4xl rounded-md mx-auto justify-center mb-20 py-20">
                        <div className="bg-white rounded-full ">
                            <Image src={'/assets/images/cartimg.png'} alt='cart image'
                                height={200} width={200}
                            />
                        </div>
                        <h2 className="text-2xl font-bold text-gray-900 mb-1">Your cart is empty</h2>
                        <p className="text-gray-600 mb-3">Your have not added any item to your cart</p>
                        <div className='w-full flex items-center justify-center'>
                            <Link className='w-1/2 lg:w-1/3 text-center mx-auto text-white rounded-full bg-primary py-2.5 px-10 gap-1'
                                href="allproducts">
                                Contine Shopping
                            </Link>
                        </div>
    ...
    return (
        <>
            <div className="w-full py-2 lg:py-5 bg-lite">
                <div className="w-11/12 lg:max-w-7xl mx-auto">
                    <Navigation routes={[
                        { name: 'Cart', href: '/marketplace/cart' }]} />
                                    ...
                                    {cart.map((item) => (
                                        <div key={item.id} className="border-b border-b-gray-200  px-4 md:px-6 py-4">
                                            ...
                                            <div className="md:hidden space-y-4">
                                                ...
                                                <div className="flex justify-between items-start">
                                                    <div className="flex items-start gap-3 flex-1">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <div className='w-fit flex items-center gap-1 bg-[#a5faa5] text-primary py-1 text-[10px] font-medium px-2 rounded-full'>
                                                                <Image
                                                                    width={6}
                                                                    height={6}
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <div className="text-left">
                                                        ...
                                                        <p className="font-semibold text-gray-900 text-sm">N{item.amount.toLocaleString()}</p>
                                                    </div>
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <div className="flex items-center gap-2 border border-gray-300 rounded-full w-fit px-2 py-1 mx-auto">
                                                            ...
                                                            <span className="w-6 text-center font-semibold text-sm">{quantities[item.id] || 1}</span>
                                                            <button
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        <p className="font-semibold text-gray-900 text-sm">N{(item.amount * (quantities[item.id] || 1)).toLocaleString()}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="hidden md:grid grid-cols-12 gap-4 items-center">
                                                ...
                                                <div className="col-span-2">
                                                    <p className="font-semibold text-gray-900">N{item.amount.toLocaleString()}</p>
                                                </div>
                                                ...
                                                <div className="col-span-1">
                                                    <p className="font-semibold text-gray-900">N{(item.amount * (quantities[item.id] || 1)).toLocaleString()}</p>
                                                </div>
                        ...
                        <div className="w-full lg:w-1/3">
                            <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-4">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <span className="text-green-600 font-semibold">{cart.length} Items</span>
                                </div>
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <div className="border-t border-t-gray-200 pt-4">
                                        ...
                                        <p className="text-sm text-gray-500">Add your delivery address at checkout to see delivery charges</p>
                                    </div>
                                ...
                                <button
                                    onClick={() => navigate('/market/marketplace/cart/checkout')}
