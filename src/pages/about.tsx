  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn about Farmstarck's journey from a family farm to Africa's leading agri-commerce ecosystem. Meet our team and discover our vision for agricultural transformation."
        />
        <meta
          name="keywords"
          content="agricultural innovation Africa, AgriTech company Nigeria, sustainable farming mission, agricultural transformation story, farming innovation leaders, agriculture technology vision, African agribusiness pioneers, digital agriculture advocates, climate-smart farming champions, agricultural ecosystem builders, farmer empowerment mission, food security advocates, agricultural company history, farming technology innovators, sustainable agriculture advocates, precision farming experts, agricultural research leaders, farm management specialists, agricultural consulting experts, agritech development team, agricultural platform creators, farming ecosystem developers, agricultural innovation labs, climate resilient agriculture, regenerative farming practices, agricultural sustainability goals, farming community builders, agricultural knowledge sharing, farm technology adoption, agricultural capacity building, farming education platform, agricultural extension services, farm advisory services, agricultural mentorship, farming best practices, agricultural research platform, farming innovation network"
        />
        <meta name="author" content="Farmstarck" />
        <meta
          property="og:title"
          content="About Farmstarck - Our Story and Mission"
        />
        <meta
          ...
          <div className="w-full max-w-6xl pt-5 mx-auto px-5 py-10 relative flex flex-col justify-center items-center ">
            <div className="w-full flex flex-col gap-3 md:gap-5 ">
              ...
              <p className="text-sm font-medium sm:text-base md:text-lg">
                ...
                struggle through the rough edges of Nigeria’s farming system.
                She planted by sunrise and fought for fair prices by sunset. She
                lost crops to poor infrastructure, faced price mafias at
                markets, and still managed to feed her children with whatever
                was left. Every season was a gamble. Every harvest, a hustle.
                Yet she never stopped.
              </p>
              <p className="text-sm font-medium sm:text-base md:text-lg">
                What she faced was more than a personal burden. It was a mirror
                of what thousands of farmers across Africa endure every day.
                That became our fuel. Today, she’s no longer just a farmer. She
                sits on our board, leads our field operations, and ensures that
                Farmstarck always remembers the people it was built to serve.
              </p>
              <p className="text-sm font-medium sm:text-base md:text-lg">
            ...
            <div className=" py-10 md:py-20 relative flex flex-col justify-center items-center gap-5 md:gap-10">
              ...
              <div className="w-full max-w-5xl m-auto space-y-8 flex flex-col items-center">
                ...
                <p className="text-sm font-medium text-center sm:text-base md:text-lg">
                  ...
                  realities of those we serve. We believe in agriculture not
                  just as a sector, but as the engine for economic
                  transformation in Africa. This is our story. And we’re just
                  getting started.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-y-5 space-y-10 py-10 md:py-16">
              <div className="w-full flex flex-col gap-3  md:gap-5 items-center ">
                ...
                <p className="text-sm w-full md:w-3/4 text-center sm:text-base md:text-lg">
                  To become Africa leading agri-commerce ecosystem, driving
            ...
            <div className="w-full max-w-6xl pt-5 mx-auto space-x-5 flex overflow-x-auto scrollbar-hide">
              <div className="flex flex-col gap-y-5 space-y-10 py-10 md:py-16">
                <div className="w-full flex flex-col gap-3  md:gap-5 items-center ">
                  ...
                  <p className="text-sm w-full md:w-3/4 text-center sm:text-base md:text-lg">
                    Meet the minds revolutionizing Africa’s agricultural
                    ecosystem
                  </p>
                </div>
                <div className="w-full max-w-5xl m-auto space-y-8 flex flex-col items-center">
