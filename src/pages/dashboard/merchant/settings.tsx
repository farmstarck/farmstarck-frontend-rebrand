...
const Settings = () => {
  ...
  const toggleOrderSetting = (key: keyof typeof orderSettings) => {
    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="bg-white py-10 flex items-start flex-col gap-5 w-full rounded-2xl shadow-sm overflow-hidden">
        ...
        <CollapsibleSection
          ...
          isOpen={expandedSections.order}
          onToggle={() => toggleSection("order")}
        >
          <div className="flex items-center justify-between py-2 px-3">
            <span className="text-gray-700">Auto Accept Orders</span>
            <NotificationToggle
              checked={orderSettings.autoAcceptOrder}
              onToggle={() => toggleOrderSetting("autoAcceptOrder")}
              ariaLabel="Toggle auto accept orders"
            />
          </div>
        </CollapsibleSection>
