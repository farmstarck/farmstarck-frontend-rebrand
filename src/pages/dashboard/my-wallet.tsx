...
const MyWallet = () => {
  ...
  useEffect(() => {
    ...
    if (router.query.funded === "true") {
      ...
      router.replace("/dashboard/my-wallet", undefined, { shallow: true });
    }
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="px-4 py-4 bg-[#fbfbfb] flex flex-col gap-4 rounded-2xl">
        ...
        <div className="w-full flex justify-center">
          <div className="bg-white text-dark rounded-2xl px-5 py-10 w-full max-w-md">
...
MyWallet.getLayout = (page: React.ReactNode) => (
