    ...
    return (
        ...
        >
            <div className="flex items-center gap-2">
                ...
                {kyc && <span className="text-xs bg-yellow-500 text-white px-2 py-0.5 rounded-full">Tier 1</span>}
            </div>
...
const Settings = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4">
            <h1 className="text-xl lg:text-2xl font-bold text-gray-800 mb-6">Settings</h1>
            ...
            <div className="bg-white py-10 flex items-start flex-col gap-5 w-full rounded-2xl shadow-sm overflow-hidden">
                ...
                >
                    ...
                    <NavigateButton label="KYC Verification" href="settings/kyc" kyc={true} />
                ...
                >
                    <NavigateButton label="Change Password" href="settings/change-password" />
                    <NavigateButton label="Two Factor Authentication" href="settings/two-factor" />
                </CollapsibleSection>
