    ...
    return (
        <div className="px-4">
            <div className=" mb-6">
                ...
                >
                    <ChevronLeft size={20} />
                    <h1 className="text-xl lg:text-2xl font-bold text-gray-800">Language</h1>
                </button>
            ...
            <div className="mt-5 w-full lg:w-fit  lg:ml-auto">
                ...
                className="w-full px-8 py-2 rounded-full text-white bg-primary">Confirm Selection</button>
            </div>
