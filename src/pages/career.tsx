  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="AgriTech careers Nigeria, agricultural jobs Africa, farming technology careers, agricultural innovation jobs, sustainable agriculture careers, precision farming jobs, agricultural platform careers, digital agriculture employment, farm technology jobs Nigeria, agricultural startup careers, climate-smart agriculture jobs, agritech employment opportunities, agricultural engineering jobs, farm management careers, agricultural data analyst jobs, agronomy positions Nigeria, agricultural software development, farm technology specialist, agricultural marketing careers, agribusiness development jobs, agricultural consultant positions, farm advisory roles, agricultural extension jobs, farming innovation careers, agricultural research positions, crop monitoring specialist, livestock management jobs, agricultural IoT careers, farm automation jobs, agricultural robotics careers, drone farming specialist, satellite agriculture jobs, agricultural fintech careers, farm blockchain developer, agricultural AI specialist, farming app development, agricultural platform engineer" />
          ...
          <div className="w-full max-w-5xl m-auto py-10 gap-y-10 flex flex-col justify-between items-center">
            <div className="">
              <div className="max-w-3xl m-auto flex flex-col gap-5 md:gap-20 items-start">
                <h2 className="text-xl sm:text-3xl md:text-4xl  text-center font-subHeading2 leading-tight font-extrabold text-[var(--dark-green)] text-centers w-full">
                  JOB OPENINGS
                </h2>
