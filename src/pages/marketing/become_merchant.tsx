...
import CompleteMerchantForm from "@/forms/CompleteMerchantForm";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="become merchant Farmstarck Nigeria Africa, sell agricultural products Nigeria platform, agro-merchant platform Africa, wholesale pricing agriculture Nigeria, farm produce selling online platform, merchant dashboard Farmstarck Nigeria, Farmstarck marketplace seller Africa, agricultural products selling Nigeria, farming merchant opportunities platform, agro-business merchant Nigeria, farm produce wholesale Africa, agricultural marketplace seller Nigeria, merchant onboarding Farmstarck platform, sell farm tools online Nigeria, agricultural inputs selling Africa, farm equipment merchant Nigeria, agrochemicals merchant platform, livestock feed selling Nigeria, processed food merchant Africa, agricultural commodities seller Nigeria, farm produce trader platform, agricultural supply chain merchant Nigeria, farming business merchant Africa, agricultural e-commerce seller Nigeria, farm produce logistics merchant platform, agricultural marketplace vendor Nigeria, farming procurement merchant Africa, agricultural sales platform Nigeria, farm produce distribution platform, agricultural business growth Nigeria, farming income merchant Africa, agricultural marketplace expansion Nigeria, farm produce selling tips platform, agricultural merchant success Nigeria, farming business strategies Africa, agricultural marketplace engagement Nigeria, farm produce selling retention platform, agricultural merchant monetization Nigeria, farming business sustainability Africa, agricultural marketplace impact Nigeria" />
      ...
      <div className="flex flex-col">
        ...
        {openModal && <CompleteMerchantForm onClose={() => setOpenModal(false)} />}
