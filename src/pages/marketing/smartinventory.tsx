...
const featuresItem = [
  {
    ...
    icon: '/assets/svg/inventory1.svg',
    iconBg:
  ...
  },
  {
    ...
    icon: '/assets/svg/inventory2.svg',
    iconBg:
  ...
  },
  {
    ...
    icon: '/assets/svg/inventory3.svg',
    iconBg:
  ...
  },
  {
    ...
    icon: '/assets/svg/inventory4.svg',
    iconBg:
  ...
  },
  {
    ...
    icon: '/assets/svg/inventory5.svg',
    iconBg:
  ...
  },
  {
    ...
    icon: '/assets/svg/inventory6.svg',
    iconBg:
  ...
  },
  {
    ...
    icon: '/assets/svg/inventory7.svg',
    iconBg:
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="Smart Inventory Farmstarck, inventory management Nigeria Africa, agricultural inventory platform, barcode scanning technology, real-time inventory tracking app, inventory analytics Nigeria platform, mobile inventory app development, farming inventory management, agricultural stock tracking, farm inventory analytics, agricultural inventory optimization, farming inventory automation, agricultural inventory AI, farm inventory blockchain, agricultural inventory fintech, farming inventory app, agricultural inventory platform, farming inventory ecosystem, agricultural inventory network, farming inventory partnerships, agricultural inventory expansion, farming inventory adoption, agricultural inventory engagement, farming inventory retention, agricultural inventory monetization, farming inventory sustainability, agricultural inventory impact, farm inventory management, agricultural stock control, farming inventory reports, agricultural inventory alerts, farm inventory reordering, agricultural inventory mobile, farming inventory integration, agricultural inventory procurement, farm inventory marketplace, agricultural inventory logistics, farming inventory supply chain, agricultural inventory traceability, farm inventory security, agricultural inventory scalability, farming inventory innovation, agricultural inventory technology, farm inventory automation, agricultural inventory robotics, farming inventory IoT, agricultural inventory drone, farm inventory satellite, agricultural inventory fintech, farming inventory blockchain, agricultural inventory AI, farm inventory app, agricultural inventory platform" />
      ...
      <div className="bg-[var(--lite)] ">
        <div className="p-5 relative flex flex-col justify-center items-center ">
          <div className="w-full flex flex-col gap-3 md:gap-5 items-center ">
            ...
            <h1 className="font-subHeading text-2xl md:text-4xl flex flex-wrap justify-center text-center text-[var(--dark-green)] font-extrabold">
              Smart Inventory{" "}
              <span className="bg-[#FACC04] font-extrabold px-5 py-0 ml-4  rounded-2xl text-center text-[var(--dark-green)] text-[0.5rem] font-btnBody">
                COMING SOON
              </span>
            </h1>
          </div>
          <div className="w-full max-w-5xl m-auto space-y-8 flex flex-col items-center mt-10 md:mt-16">
            <Image
              height={900}
              width={900}
              src={'/assets/images/inventory-hero.png'}
              alt="inventory-img"
            ...
            <div className="flex flex-wrap w-full justify-center md:justify-between items-center gap-y-5 md:gap-y-10 gap-x-3 md:gap-x-8">
              {featuresItem.map((item, i) => (
                ...
                >
                  ...
                  <h2 className="font-semibold text-[var(--dark-green)] text-center pt-2 text-sm md:text-base h-24 md:h-12">
                    {item.header}
                  </h2>
                </div>
              ))}
              ...
              <div className="flex flex-col gap-4 md:space-y-5">
                <div className="flex flex-col justify-between gap-5  w-full md:gap-5">
                  <input
                    ...
                    className="w-full h-10  p-5 rounded-full border-2 border-[var(--primary)] bg-white text-gray-700 font-light text-sm placeholder-gray-700 focus:outline-none "
                  />
                </div>
              </div>
              <div>
